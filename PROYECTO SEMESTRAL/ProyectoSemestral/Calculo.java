...
public class Calculo {
    ...
    public int obtenerX(String coordenada) {
        char xChar = Character.toUpperCase(coordenada.charAt(0));
        int x;
    ...
    public String obtenerCoordAtaque()throws IOException{
        BufferedReader Ojitos = new BufferedReader(new InputStreamReader(System.in));
        String coordenada;
        System.out.println("Ingrese la coordenada de su cohete: ");
        coordenada = Ojitos.readLine();
        return coordenada;
    }
}